            ...
            <div class="card mt-5">
                <div class="card-body">
                    ...
                    <form action="{{ URL::to('/login/do'); }}" method="POST" autocomplete="off">
                        ...
                        <button class="btn btn-primary mt-4 px-2">Sign In <i class="fas fa-sign-in-alt"></i></button>        
                        <a href="{{ url('authorized/google') }}" >
                            <img class="mt-4" src="https://developers.google.com/identity/images/btn_google_signin_dark_normal_web.png" >
                        </a>                              
                    </form>
                </div>
            </div>
