                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="app-content">
                                ...
                                <div class="app-scan aos" data-aos="fade-up">
                                    ...
                                    <img src="{{ URL::to('/')}}/assets/img/scan-img.png" alt="">
                                </div>
                                <div class="google-imgs aos" data-aos="fade-up">
                                    <a href="javascript:void(0);"><img src="{{ URL::to('/')}}/assets/img/google-play.png" alt="img"></a>
                                    <a href="javascript:void(0);"><img src="{{ URL::to('/')}}/assets/img/app-store.png" alt="img"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 aos" data-aos="fade-up">
                            <div class="mobile-img">
                                <img src="{{ URL::to('/')}}/assets/img/mobile-img.png" class="img-fluid" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
